...
<div class="overflow-hidden bg-white shadow-md rounded-lg">
    <table class="w-full border-collapse sortable-table">
        <!-- Table Head -->
        <thead class="bg-blue-800 text-white">
            <tr>
                <th class="px-4 py-2 border border-gray-300 text-left md:hidden">@lang('site.details')</th>
                <th class="px-4 py-2 border border-gray-300 text-left hidden md:table-cell">Drag</th>
        ...
        <tbody class="divide-y divide-gray-300 bg-gray-50">
            @forelse ($data as $row)
                <tr class="hover:bg-gray-100 transition" x-data="{ expanded: false }" data-id="{{ $row->id }}" data-order-num="{{ $row->order_num }}">
                            ...
                            @foreach ($columns as $col)
                                <div class="flex justify-between py-1">
                                    ...
                                    <span>
                                        ...
                                        @else
                                            <span class="{{ $col === 'order_num' ? 'order-num' : '' }}">{{ $row->$col ?? '—' }}</span>
                                        @endif
                                    </span>
                                </div>
                            @endforeach
                    ...
                    <!-- Drag Handle Column -->
                    <td class="px-4 py-2 border border-gray-300 hidden md:table-cell drag-handle cursor-move">
            ...
            @empty
                <tr>
                    <td colspan="{{ count($columns) + 2 }}" class="px-4 py-2 text-center text-gray-500">
